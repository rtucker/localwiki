...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentConfiguration_hist'
        db.create_table('comments_commentconfiguration_hist', (
            ('id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('heading', self.gf('django.db.models.fields.CharField')(default='Comments', max_length=250)),
            ...
            ('history_reverted_to_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.CommentConfiguration_hist'], null=True)),
        ...
        db.send_create_signal('comments', ['CommentConfiguration_hist'])

    def backwards(self, orm):
        # Deleting model 'CommentConfiguration_hist'
        db.delete_table('comments_commentconfiguration_hist')
    ...
    models = {
        ...
        'comments.comment': {
            ...
            'content': ('ckeditor.models.HTML5FragmentField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['pages.Page']"})
        },
        'comments.comment_hist': {
            'Meta': {'ordering': "('-history_date',)", 'object_name': 'Comment_hist'},
            'content': ('ckeditor.models.HTML5FragmentField', [], {}),
            'history_comment': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'history_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'history_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'history_reverted_to_version': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['comments.Comment_hist']", 'null': 'True'}),
        ...
        'comments.commentconfiguration': {
            'Meta': {'object_name': 'CommentConfiguration'},
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'heading': ('django.db.models.fields.CharField', [], {'default': "'Comments'", 'max_length': '250'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['pages.Page']", 'unique': 'True'})
        },
        'comments.commentconfiguration_hist': {
            'Meta': {'ordering': "('-history_date',)", 'object_name': 'CommentConfiguration_hist'},
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'heading': ('django.db.models.fields.CharField', [], {'default': "'Comments'", 'max_length': '250'}),
            'history_comment': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'history_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'history_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'history_reverted_to_version': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['comments.CommentConfiguration_hist']", 'null': 'True'}),
            'history_type': ('django.db.models.fields.SmallIntegerField', [], {}),
            'history_user': ('versionutils.versioning.fields.AutoUserField', [], {'to': "orm['auth.User']", 'null': 'True'}),
            'history_user_ip': ('versionutils.versioning.fields.AutoIPAddressField', [], {'max_length': '15', 'null': 'True'}),
            'id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentConfiguration'
        db.create_table('comments_commentconfiguration', (
        ...
        db.send_create_signal('comments', ['CommentConfiguration'])

    def backwards(self, orm):
        # Deleting model 'CommentConfiguration'
        db.delete_table('comments_commentconfiguration')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('comments_comment', (
            ...
            ('content', self.gf('ckeditor.models.HTML5FragmentField')()),
        ))
        db.send_create_signal('comments', ['Comment'])

        # Adding model 'Comment_hist'
        db.create_table('comments_comment_hist', (
            ...
            ('history_reverted_to_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['comments.Comment_hist'], null=True)),
        ...
        db.send_create_signal('comments', ['Comment_hist'])

    def backwards(self, orm):
        # Deleting model 'Comment'
        db.delete_table('comments_comment')

        # Deleting model 'Comment_hist'
        db.delete_table('comments_comment_hist')
